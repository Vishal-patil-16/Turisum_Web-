            ...
            <div class="contact-image">
               ...
               <div class="row">
					...
					<div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
							...
							<p><button type="button" class="btn btn-danger"><a href="deletePackage.php?p_id=<?php echo $p_id; ?>" style="color: white">Cancel Booking</a></button>							
							</p>
...
<!-- 	<section id="contact" class="contact">
	<div class="container">
		<div class="row">
			...
			<div class="row">
				<div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<img src="assets/img/a.jpg" style="width: 350px; height: 240px">
				</div>
