...
$insert_c = "INSERT INTO `customer_details`(`full_name`, `uid`, `mobile`, `email`, `password`) VALUES ('$fname','$uid','$mobile','$email','$password')";
...
<body>
	...
	<div class="bg-img" align="left">
		...
		<div class="row">
			...
			<div class="col-lg-5">
				<form action="userRegistration.php" class="contain" method="post">
				<h1>User Registration</h1>
				<label for="username"><b>Name</b></label> <input type="text"
					placeholder="Enter Full Name" name="fname" required> 
				<label for="username"><b>UID ID</b></label> <input type="text"
					placeholder="Enter Adhar Card Number" name="uid" required> 
				<label for="username"><b>Mobile No</b></label> <input type="text"
				...
				<button type="submit" class="btn" name="login" value="Login">Registration</button>
			</form>
			</div>		
