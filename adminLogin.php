...
<body>
	...
	<div class="bg-img" align="left">
		<br> <br> <br>
			...
			<form action="adminLogin.php" class="contain" method="post">
				<h1>Admin Login</h1>
	...
	if(isset($_POST['login']))
	{
		...
		$c_username = mysql_real_escape_string($_POST['username']);
		$c_pass = mysql_real_escape_string($_POST['password']);
		
		$sel_c = "select * from admin_details where password='$c_pass' AND username='$c_username' ";
